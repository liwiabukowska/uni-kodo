...
namespace tga
{
	...
	*/
	...
	inline void TGA::MonochromeCompressed(uint8_t* InBuffer, uint8_t* OutBuffer, size_t Size)
	{
		uint8_t Header;
		uint8_t Red;
	...
	inline void TGA::RGBCompressed(uint8_t* InBuffer, uint8_t* OutBuffer, size_t Size)
	{
		uint8_t Header;
		uint8_t Red, Green, Blue;
		size_t i, j, PixelCount;
	...
	inline void TGA::RGBACompressed(uint8_t* InBuffer, uint8_t* OutBuffer, size_t Size)
	{
		uint8_t Header;
		uint8_t Red, Green, Blue, Alpha;
		size_t i, j, PixelCount;
